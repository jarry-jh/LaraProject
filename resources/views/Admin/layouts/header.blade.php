...
<link rel="stylesheet" href="{{url('public/Admin/css/morris.css')}}" type="text/css"/>
<!-- calendar -->
<link rel="stylesheet" href="{{url('public/Admin/css/monthly.css')}}">
<!-- //calendar -->
<!-- //font-awesome icons -->
<script src="{{url('public/Admin/js/jquery2.0.3.min.js')}}"></script>
<script src="{{url('public/Admin/js/raphael-min.js')}}"></script>
<script src="{{url('public/Admin/js/morris.js')}}"></script>
</head>
<body>
    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">                                                     
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                ...
                @else
                <!-- <span class="username">no data</span> -->
                @endif
