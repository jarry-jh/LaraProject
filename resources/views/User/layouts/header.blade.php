...
<link rel="stylesheet" href="{{url('public/User/css/morris.css')}}" type="text/css"/>
<!-- calendar -->
<link rel="stylesheet" href="{{url('public/User/css/monthly.css')}}">
<!-- //calendar -->
<!-- //font-awesome icons -->
<script src="{{url('public/User/js/jquery2.0.3.min.js')}}"></script>
<script src="{{url('public/User/js/raphael-min.js')}}"></script>
<script src="{{url('public/User/js/morris.js')}}"></script>
</head>
<body>
...
<div class="top-nav clearfix">
    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                <img alt="" src="{{url('public/User/images/2.png')}}">
            ...
            <ul class="dropdown-menu extended logout">
                ...
                <li><a href="{{url('/ulogout')}}"><i class="fa fa-key"></i> Log Out</a></li>
            </ul>
        </li>
